...
const (
	...
	// skips C1 Controls, Surrogates, Noncharacters (U+FDD0-U+FDEF), and Specials (U+xxFFF0-U+xxFFFF)
	utf8Exclude  = utf8C1Control + utf8Surrogate + utf8Noncharacter + utf8Replacement + utf8Special
